...
public class LoanCalc {
	...
	public static void main(String[] args) {
		...
		System.out.println("endbalabce: " + endBalance(loan, rate, n, 10000));
		System.out.println("endbalabce: " + endBalance(loan, rate, n, 12950));
		System.out.println("endbalabce: " + endBalance(loan, rate, n, 12951));
	...
	private static double endBalance(double loan, double rate, int n, double payment) {
		double sum = loan;
		for (int i = 0; i < n; i++) {
			sum = (sum - payment) * (rate / 100.0 + 1.0);
		}
	...
	public static double bisectionSolver(double loan, double rate, int n, double epsilon) {
		...
		while (endBalance(loan, rate, n, lo) < 0) {
			lo /= 2;
		}
